...
## Current selected result: 0.839390
...
| MRR | 0.641633 | 30% |
| Efficiency | 0.809500, from MTTC 2.905 | 20% |

```text
TechnicalScore = 0.50 × 0.970000 + 0.30 × 0.641633 + 0.20 × 0.809500
               = 0.839390, rounded to six decimals
```
...
Of our 179 successful sessions, 99 first hit at rank 1 and 80 at ranks 2–10; 21 sessions missed. Relative to the formal 1.0 reference, the weighted gaps are 0.052500 in hits, 0.115876 in reciprocal rank and 0.044900 in turn efficiency. These gaps overlap in their causes: recovering a miss improves several components at once. They are not independent predicted gains.
